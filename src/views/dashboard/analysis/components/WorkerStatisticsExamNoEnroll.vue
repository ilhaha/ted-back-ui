...
import { getStatisticsExamNoEnroll } from '@/apis/exam/examPlan'
    ...
    tooltip: {
      ...
      formatter: (params: any) => {
        ...
        if (detailData.value.length > 0) {
          let tableHtml = `
            <table style="border-collapse: collapse; font-size: 12px; table-layout: fixed;">
              ...
              <tr style="background: #f0f0f0;">
                ...
                <th style="padding: 4px 6px; border: 1px solid #ddd; text-align: right;">未报名人数</th>
              </tr>
          `
          ...
          return `
            <div style="min-width: 220px;">
              ...
              <div style="color: #666; margin-bottom: 8px;">未报名人数：${recordCount}</div>
        ...
        return `<div style="min-width: 200px;">
          ...
          <div style="color: #666;">未报名人数：${recordCount}</div>
...
const getChartData = async () => {
  try {
    loading.value = true
    const { data } = await getStatisticsExamNoEnroll()
