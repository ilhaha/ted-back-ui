...
import { type CandidateExamPaperDetailResp, getCandidateExamPaper as getDetail } from '@/apis/exam/candidateExamPaper'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<CandidateExamPaperDetailResp>()
