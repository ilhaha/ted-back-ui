<template>
  <a-drawer v-model:visible="visible" title="无损检测知识类型占比详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
    <a-descriptions :column="2" size="large" class="general-description">
      ...
      <a-descriptions-item label="每题分值">{{ dataDetail?.points }}</a-descriptions-item>
