<template>
  <a-drawer v-model:visible="visible" title="考试通知与考试计划关联详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
...
import { type ExamNoticePlanDetailResp, getExamNoticePlan as getDetail } from '@/apis/exam/examNoticePlan'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<ExamNoticePlanDetailResp>()
