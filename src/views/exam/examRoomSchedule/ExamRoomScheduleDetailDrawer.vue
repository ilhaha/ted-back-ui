<template>
  <a-drawer v-model:visible="visible" title="检验检测人员考试考场安排详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
    <a-descriptions :column="2" size="large" class="general-description">
      ...
      <a-descriptions-item label="考场ID">{{ dataDetail?.examRoomId }}</a-descriptions-item>
      <a-descriptions-item label="考试时间">{{ dataDetail?.examTime }}</a-descriptions-item>
...
import { type ExamRoomScheduleDetailResp, getExamRoomSchedule as getDetail } from '@/apis/exam/examRoomSchedule'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<ExamRoomScheduleDetailResp>()
