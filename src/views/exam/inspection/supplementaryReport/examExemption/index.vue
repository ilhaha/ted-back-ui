<template>
  <div class="gi_table_page">
    <GiTable title="检验在线补报 - 免考换证" row-key="id" :data="dataList" :columns="columns" :loading="loading"
...
import { type ExamNoticeResp, type ExamNoticeQuery, supplementaryReportPage, openOrCloseSupplementaryReport } from '@/apis/exam/examNotice'
...
defineOptions({ name: 'InspectionSupplementaryReportExamExemption' })
