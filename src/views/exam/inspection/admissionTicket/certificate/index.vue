<template>
  <div class="gi_table_page">
    <GiTable title="检验准考证管理 - 取证" row-key="id" :data="dataList" :columns="columns" :loading="loading"
...
import { type ExamNoticeResp, type ExamNoticeQuery, admissionTicketPage } from '@/apis/exam/examNotice'
...
const AdmissionTicketDetailModalRef = ref<InstanceType<typeof AdmissionTicketDetailModal>>()
