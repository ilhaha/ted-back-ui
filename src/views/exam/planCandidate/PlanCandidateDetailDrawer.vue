<template>
  <a-drawer v-model:visible="visible" title="计划与考生关系详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
...
import { type PlanCandidateDetailResp, getPlanCandidate as getDetail } from '@/apis/exam/planCandidate'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<PlanCandidateDetailResp>()
