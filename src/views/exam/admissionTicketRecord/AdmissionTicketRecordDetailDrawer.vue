<template>
  <a-drawer v-model:visible="visible" title="下载准考证记录详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
...
import { type AdmissionTicketRecordDetailResp, getAdmissionTicketRecord as getDetail } from '@/apis/exam/admissionTicketRecord'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<AdmissionTicketRecordDetailResp>()
