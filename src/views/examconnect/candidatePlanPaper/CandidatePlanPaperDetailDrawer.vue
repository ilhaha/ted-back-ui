<template>
  <a-drawer v-model:visible="visible" title="考生试卷详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
    <a-descriptions :column="2" size="large" class="general-description">
      ...
      <a-descriptions-item label="试卷 JSON 内容">{{ dataDetail?.paperJson }}</a-descriptions-item>
...
import { type CandidatePlanPaperDetailResp, getCandidatePlanPaper as getDetail } from '@/apis/examconnect/candidatePlanPaper'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<CandidatePlanPaperDetailResp>()
