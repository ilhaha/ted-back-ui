<template>
  <a-drawer v-model:visible="visible" title="项目培训关联详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
...
import { type ProjectTrainingDetailResp, getProjectTraining as getDetail } from '@/apis/training/projectTraining'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<ProjectTrainingDetailResp>()
